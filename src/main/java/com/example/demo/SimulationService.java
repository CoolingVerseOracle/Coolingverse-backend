...
public class SimulationService {
    ...
    private static final java.util.Map<String, double[]> REGION_ANCHOR_DELTA = java.util.Map.of(
            ...
            // ⚠️ 평촌 앵커는 v3 데이터셋(활동 격자 329개) 기준이다. v2(877격자)가 적재된 상태에서
            //    이 값을 쓰면 감소폭이 과대 계상된다 — 데이터 재적재와 함께 배포할 것.
            "pyeongchon", new double[]{0, 0.16, 0.47, 0.78, 1.09, 1.56} // baseline 51.05, 최대 -1.56
    );
